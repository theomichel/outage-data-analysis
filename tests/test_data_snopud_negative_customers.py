"""
SNOPUD Negative Customers Test Data
Provides test data for testing SNOPUD outage processing when the previous snapshot has an outage with -1 affected customers.
The -1 outage should be skipped, and only the current snapshot with 101 customers should be processed.
"""

import json

def get_default_mock_data():
    """Negative customers test scenario: Previous snapshot has -1 customers, current has 101 customers"""
    
    # Mock Git commit data with two SNOPUD KML files (previous and current)
    return {
        "commits": [
            {
                "hash": "abc123",
                ...
                "message": "Add SNOPUD outage data - previous snapshot",
                "files": {
...
<Data name="EstCustomersOut"><value>-1</value></Data>
...
<coordinates>-121.893142092459,48.1090976513446,0 -121.887738391831,48.1090806645585,0 -121.882334694792,48.1090634236574,0 -121.882350762292,48.1126891721402,0 -121.893142092459,48.1090976513446,0</coordinates>
            ...
            },
            {
                ...
                "message": "Add SNOPUD outage data - current snapshot",
                "files": {
                    "KMLOutageAreas.xml": """<?xml version="1.0" encoding="UTF-8"?>
<kml xmlns="http://www.opengis.net/kml/2.2">
<Document>
...
<Data name="StartUTC"><value>2025-01-15T13:26:42.0000000+00:00</value></Data>
<Data name="Cause"><value>Equipment Failure</value></Data>
<Data name="EstCustomersOut"><value>101</value></Data>
<Data name="UploadTimestampUTC"><value>2025-01-15T14:40:03.0000000+00:00</value></Data>
<Data name="EstimatedRestorationUTC"><value>2025-01-16T04:45:00.0000000+00:00</value></Data>
<Data name="OutageStatus"><value>We're investigating</value></Data>
<Data name="IsStormModeData"><value>False</value></Data>
<Data name="DistrictBroadcastMessages"><value>[]</value></Data>
<Data name="RegionBroadcastMessages"><value>[]</value></Data>
