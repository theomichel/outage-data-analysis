...
def get_default_mock_data():
    ...
    large_outage_content = json.dumps({
        "UnplannedOutageSummary": {"CustomerAfftectedCount": 2000, "OutageCount": 1, "LastUpdatedDatetime": "01/15 5:45 PM"},
        "PlannedOutageSummary": {"CustomerAfftectedCount": 0, "OutageCount": 0, "LastUpdatedDatetime": "01/15 5:45 PM"},
        "PSPSSummary": {"CustomerAfftectedCount": 0, "OutageCount": 0, "LastUpdatedDatetime": "01/15 5:45 PM"},
        ...
        "PseMap": [{
            "DataProvider": {
                "Attributes": [
                    ...
                    {"Name": "Start time", "RefName": "StartDate", "Value": "01/15 5:00 PM"},
                    {"Name": "Est. restoration time", "RefName": "Est. Restoration time", "Value": "01/15 7:00 PM"},
                    {"Name": "Status", "RefName": "Status", "Value": "Crew assigned"},
                    {"Name": "Cause", "RefName": "Cause", "Value": "Transformer failure"},
                    {"Name": "Last update", "RefName": "LastUpdated", "Value": "01/15 5:46 PM"}
                ],
                "PointOfInterest": {
        ...
        'commits': [
            {
                ...
                'datetime': '2024-01-16T02:00:00+00:00',
                'files': {
            ...
            },
            {
                ...
                'datetime': '2024-01-16T01:45:00+00:00',
                'files': {
