"""
Resolved Outage Test Data - Above Threshold Scenario
Provides test data for testing resolved outage detection when outage meets thresholds
"""

import json

def get_default_mock_data():
    """Resolved outage test scenario: Large outage that gets resolved and meets thresholds"""
    
    # Large outage for previous snapshot - meets all thresholds
        ...
        "PseMap": [{
            "DataProvider": {
                "Attributes": [
                    ...
                    {"Name": "Start time", "RefName": "StartDate", "Value": "01/15 3:00 AM"},
